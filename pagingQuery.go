...
type PagingQuery interface {
	...
	Find(ctx context.Context) (paginatedData *PaginatedData, err error)

	Aggregate(ctx context.Context, criteria ...interface{}) (paginatedData *PaginatedData, err error)
...
func New(collection *mongo.Collection) PagingQuery {
	return &pagingQuery{
		PagingCountDur: 5 * time.Second,
		Collection:     collection,
	}
}

// WithPagingCountTimeout set default total paging count query timeout, default is 5 seconds
func (paging *pagingQuery) WithPagingCountTimeout(t time.Duration) PagingQuery {
	paging.PagingCountDur = t
...
func (paging *pagingQuery) Aggregate(ctx context.Context, filters ...interface{}) (paginatedData *PaginatedData, err error) {
...
func (paging *pagingQuery) Find(ctx context.Context) (paginatedData *PaginatedData, err error) {
